...
async function getSalesforceAccessToken() {
    ...
    const generateSFAccesstoken = await apiRequestContext.post(url, {
    ...
    const SFaccessTokenresponse = await generateSFAccesstoken.json();
    console.log(SFaccessTokenresponse);

    return{

        access_token: SFaccessTokenresponse.access_token,
        inst_url: SFaccessTokenresponse.instance_url
